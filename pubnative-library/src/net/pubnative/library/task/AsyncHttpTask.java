...
public class AsyncHttpTask extends AsyncTask<String, Void, String>
{
    ...
    protected String doInBackground(String... params)
    {
        ...
        if (params.length > 0)
        {
            ...
            {
                this.invokeFailed(new Exception("Pubnative - URL not valid: " + url));
            }
        }
        else
        {
    ...
    private void invokeFinished(String result)
    {
        ...
        {
            this.listener.get().onHttpAsyncJsonFinished(this, result);
        }
    }
    ...
    private void invokeFailed(Exception exception)
    {
        if (this.listener != null && this.listener.get() != null)
        {
            this.listener.get().onHttpAsyncJsonFailed(this, exception);
        }
    }
