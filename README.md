...
```
compile 'net.pubnative:library:2.3.12'
```
...
Add the following line to your module dependencies
```
compile 'net.pubnative:library.interstitial:2.3.12'
```
Sample usage
```
...
Add the following line to your module dependencies
```
compile 'net.pubnative:library.banner:2.3.12'
```
Sample usage
```
...
Add the following line to your module dependencies
```
compile 'net.pubnative:library.video:2.3.12'
```
Sample usage
```
...
Add the following line to your module dependencies
```
compile 'net.pubnative:library.feed.video:2.3.12'
```
Sample usage
```
